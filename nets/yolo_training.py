...
class L_color(nn.Module):#颜色恒定损失
...
#PIA: Parallel Architecture with Illumination Allocator for Joint Enhancement and Detection in Low-Light (ACM MM 2022)的损失函数
class LossFunction(nn.Module):
    ...
    def forward(self, input, u_list, t_list):#低光输入，反射率，光照图
        Fidelity_Loss = 0
...
class SmoothLoss(nn.Module):#平滑损失
    def __init__(self):
