...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, backbone='cspdarknet', pretrained=False, input_shape=[640, 640]):
        ...
        self.conv3_for_upsample2    = C3(base_channels * 8, base_channels * 4, base_depth, shortcut=False)#shortcut=False时，2x3个CBS代替残差组件
    ...
    def forward(self, x):
        ...
        P5          = self.conv_for_feat3(feat3)#1x1卷积
        # 20, 20, 512 -> 40, 40, 512
        P5_upsample = self.upsample(P5)
        # 40, 40, 512 -> 40, 40, 1024
        P4          = torch.cat([P5_upsample, feat2], 1)
        # 40, 40, 1024 -> 40, 40, 512
        P4          = self.conv3_for_upsample1(P4)#C2_2

        # 40, 40, 512 -> 40, 40, 256
        P4          = self.conv_for_feat2(P4)#CBS 1x1卷积+BN+SiLu
        # 40, 40, 256 -> 80, 80, 256
        P4_upsample = self.upsample(P4)
        # 80, 80, 256 cat 80, 80, 256 -> 80, 80, 512
        P3          = torch.cat([P4_upsample, feat1], 1)
        # 80, 80, 512 -> 80, 80, 256
        P3          = self.conv3_for_upsample2(P3)#C2_2
        ...
        # 40, 40, 512 -> 40, 40, 512
        P4 = self.conv3_for_downsample1(P4)#C2_2
        ...
        P5 = self.conv3_for_downsample2(P5)#C2_2
